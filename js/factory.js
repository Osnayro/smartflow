...
Capa Archivo Rol
Catálogo catalog.js v4.1.2 Define qué existe (materiales, dimensiones, specs)
Core core.js v7.0 Gestiona el grafo de ingeniería (objetos, relaciones, reglas)
Factory factory.js v1.0 NUEVO - Traduce catálogo → objetos Core con defaults inteligentes

Ejemplo de uso:

```javascript
// Crear un skid de bombeo completo
const skid = SmartFlowFactory.createPumpSkid('SIST-01', 5000, 0, 3000, {
    spec: 'A3B',
    material: 'SS'
});

// Insertar un transmisor de presión en la descarga
SmartFlowFactory.createAndRegisterInstrument('PRESSURE_TRANSMITTER', 'PT-101', 'SIST-01-L-DESC', 0.5, {
    range: '0-10 bar',
    location: 'FIELD',
    loopTag: 'PIC-101'
});

// Crear PFD stream vinculado
SmartFlowFactory.createAndRegisterStream('S1', 'SIST-01-TK', 'SIST-01-FL', {
    fluid: 'WATER',
    flow: 25,
    flowUnit: 'm3/h'
});
